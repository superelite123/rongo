...
class SearchParameters {
    ...
    /**
     * Bitcoin検索パラメータを取得する<br>
     *
     * @return BitcoinSearchParameter Bitcoin検索パラメータ
     */
    ...
    /**
     * Bitcoin検索パラメータを設定する<br>
     *
     * @param BitcoinSearchParameter $bitcoin Bitcoin検索パラメータ
     */
     ...
     *
     * @param PayPaySearchParameter $cvspay PayPay検索パラメータ
     */
