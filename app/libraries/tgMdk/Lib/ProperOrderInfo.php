...
class ProperOrderInfo {
     ...
     * 支払金額（BTC）
     */
    private $paymentAmountBtc;

    /**
     * 承認日時
     */
    private $paymentFixDatetime;
    ...
    /**
     * 商品説明を設定する<br>
     * @param string $itemDescription 商品説明
     */
     ...
     *
     * @param string $bitcoinServiceType ビットコインサービスタイプ
     */
     ...
     * 支払金額を設定する<br>
     *
     * @param string $paymentAmount 支払金額
     */
     ...
     * 支払金額（BTC）を取得する<br>
     *
     * @return string 支払金額（BTC）
     */
    public function getPaymentAmountBtc() {
        return $this->paymentAmountBtc;
    }

    /**
     * 支払金額（BTC）を設定する<br>
     *
     * @param string $paymentAmountBtc 支払金額（BTC）
     */
    public function setPaymentAmountBtc($paymentAmountBtc) {
        $this->paymentAmountBtc = $paymentAmountBtc;
    }
     ...
     * @return string 承認日時
     */
    public function getPaymentFixDatetime() {
        return $this->paymentFixDatetime;
    }

    /**
     * 承認日時を設定する<br>
     *
     * @param string $paymentFixDatetime 承認日時
     */
    public function setPaymentFixDatetime($paymentFixDatetime) {
        $this->paymentFixDatetime = $paymentFixDatetime;
    }

    /**
     * 残高（BTC）を取得する<br>
     *
     * @return string 残高（BTC）
     */
     ...
     * 残高（BTC）を設定する<br>
     *
     * @param string $balanceBtc 残高（BTC）
     */
     ...
     * ビットコイン取引番号を取得する<br>
     *
     * @return string ビットコイン取引番号
     */
    public function getBitcoinOrderId() {
        return $this->bitcoinOrderId;
    }

    /**
     * ビットコイン取引番号を設定する<br>
     *
     * @param string $bitcoinOrderId ビットコイン取引番号
     */
    public function setBitcoinOrderId($bitcoinOrderId) {
     ...
     * CvsPayオーダーIDを設定する
     *
     * @param $cvspayOrderId CvsPayオーダーID
     */
