...
class ProperTransactionInfo {
    ...
    */
     ...
     * ビットコイン決済事業者への要求日時
     */
    private $bitcoinRequestDatetime;

    /**
     * ビットコイン決済事業からの返戻日時
     */
    private $bitcoinResponseDatetime;
   ...
   /**
     ...
     *
     * @param string $setReq3dTransactionStatus 要求3Dトランザクションステータス<br>
     */
     ...
     * 楽天APIエラーコードを設定する<br>
     *
     * @param string $rakuteApiErrorCode 楽天エラーコード<br>
     */
     ...
     * 楽天取引エラーコードを設定する<br>
     *
     * @param string $rakuteOrderErrorCode 楽天取引エラーコード<br>
     */
     ...
     * 金額（BTC）を設定する<br>
     *
     * @param string $amountBtc 金額（BTC）<br>
     */
    ...
    /**
     * ビットコイン決済事業者への要求日時を設定する<br>
     *
     * @param string $bitcoinRequestDatetime ビットコイン決済事業者への要求日時<br>
     */
    public function setBitcoinRequestDatetime($bitcoinRequestDatetime) {
        $this->bitcoinRequestDatetime = $bitcoinRequestDatetime;
    }

    /**
     * ビットコイン決済事業者への要求日時を取得する<br>
     *
     * @return string ビットコイン決済事業者への要求日時<br>
     */
    public function getBitcoinRequestDatetime() {
        return $this->bitcoinRequestDatetime;
    }

    /**
     * ビットコイン決済事業からの返戻日時を設定する<br>
     *
     * @param string $bitcoinResponseDatetime ビットコイン決済事業からの返戻日時<br>
     */
    public function setBitcoinResponseDatetime($bitcoinResponseDatetime) {
        $this->bitcoinResponseDatetime = $bitcoinResponseDatetime;
    }

    /**
     * ビットコイン決済事業からの返戻日時を取得する<br>
     *
     * @return string ビットコイン決済事業からの返戻日時<br>
     */
    public function getBitcoinResponseDatetime() {
        return $this->bitcoinResponseDatetime;
    }
