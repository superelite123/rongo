...
/**
 * 決済サービスタイプ：ビットコイン、コマンド名：決済申込の応答Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class BitcoinAuthorizeResponseDto extends MdkBaseDto
{
     ...
     * 半角数字<br/>
     * 最大桁数：17<br/>
     * ビットコインの通貨単位に換算された決済金額を返却します（小数点を含む）<br/>
     */
    private $amountBtc;
     ...
     * ※ 現在は未使用の項目です。<br/>
     */
    private $bitcoinQrCodeSmallImgUrl;
     ...
     * ※ 現在は未使用の項目です。<br/>
     */
    private $bitcoinQrCodeLargeImgUrl;
    ...
    /**
     * 決済金額（BTC）を設定する<br>
     * @param string $amountBtc 決済金額（BTC）<br>
     */
     ...
     */
    public function getBitcoinQrCode() {
        return $this->bitcoinQrCode;
    }

    /**
     * QRコードを設定する<br>
     * @param string $bitcoinQrCode QRコード<br>
     */
    public function setBitcoinQrCode($bitcoinQrCode) {
        $this->bitcoinQrCode = $bitcoinQrCode;
    }
     ...
     */
    public function getBitcoinQrCodeImgUrl() {
        return $this->bitcoinQrCodeImgUrl;
    }

    /**
     * QRコード画像URL（標準）を設定する<br>
     * @param string $bitcoinQrCodeImgUrl QRコード画像URL（標準）<br>
     */
    public function setBitcoinQrCodeImgUrl($bitcoinQrCodeImgUrl) {
        $this->bitcoinQrCodeImgUrl = $bitcoinQrCodeImgUrl;
    }
     ...
     */
    public function getBitcoinQrCodeSmallImgUrl() {
        return $this->bitcoinQrCodeSmallImgUrl;
    }

    /**
     * QRコード画像URL（縮小）を設定する<br>
     * @param string $bitcoinQrCodeSmallImgUrl QRコード画像URL（縮小）<br>
     */
    public function setBitcoinQrCodeSmallImgUrl($bitcoinQrCodeSmallImgUrl) {
        $this->bitcoinQrCodeSmallImgUrl = $bitcoinQrCodeSmallImgUrl;
    }
     ...
     */
    public function getBitcoinQrCodeLargeImgUrl() {
        return $this->bitcoinQrCodeLargeImgUrl;
    }

    /**
     * QRコード画像URL（拡大）を設定する<br>
     * @param string $bitcoinQrCodeLargeImgUrl QRコード画像URL（拡大）<br>
     */
    public function setBitcoinQrCodeLargeImgUrl($bitcoinQrCodeLargeImgUrl) {
        $this->bitcoinQrCodeLargeImgUrl = $bitcoinQrCodeLargeImgUrl;
    }
