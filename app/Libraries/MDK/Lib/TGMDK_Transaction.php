<?php
// namespace App\Libraries\MDK\Lib;
// use App\Libraries\MDK\Lib\tgMdkDto\AbstractPaymentRequestDto;
// use App\Libraries\MDK\Lib\TGMDK_Logger;
if (realpath($_SERVER["SCRIPT_FILENAME"]) == realpath(__FILE__)) die('Permission denied.');

if (!defined('MDK_LIB_DIR')) require_once(app_path().'\Libraries\MDK\3GPSMDK.php');
...
class TGMDK_Transaction {
     ...
     * @param array $props マルチマーチャント用設定内容
     ...
     */
    private function createSendUrl($requestDto, $serviceType, $serviceCommand, $conf_array) {
